...
namespace samesign 
{
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////
    std::vector<std::pair<int, int> > additionalLeptons(const int idx, const float min_lep_pt);
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////
    bool has3rdLepton(const int idx, const float min_lep_pt);
    ...
    std::vector<int> getJetMcAlgoMatch(int idx, enum JetType type, float deltaR = 0.4, float min_pt = 40.0, float max_eta = 2.4, float mu_minpt = 20.0, float ele_minpt = 20.0, float rescale = 1.0, int systFlag = 0, bool sort_by_pt = true);

    std::vector<int> getJetMcAlgoMatch(int idx, FactorizedJetCorrector* jet_corrector, enum JetType type, float deltaR = 0.4, float min_pt = 40.0, float max_eta = 2.4, float mu_minpt = 20.0, float ele_minpt = 20.0, float rescale = 1.0, int systFlag = 0, bool sort_by_pt = true);

    std::vector<int> getJetMcAlgoMatch(int idx, JetCorrectionUncertainty *jet_unc, enum JetScaleType scale_type, enum JetType type, float deltaR = 0.4, float min_pt = 40.0, float max_eta = 2.4, float mu_minpt = 20.0, float ele_minpt = 20.0, bool sort_by_pt = true);	 

    std::vector<int> getJetMcAlgoMatch(int idx, FactorizedJetCorrector* jet_corrector, JetCorrectionUncertainty *jet_unc, enum JetScaleType scale_type, enum JetType type, float deltaR = 0.4, float min_pt = 40.0, float max_eta = 2.4, float mu_minpt = 20.0, float ele_minpt = 20.0, bool sort_by_pt = true);	 
    ...
    std::vector<int> getJetMcPhysMatch(int idx, enum JetType type, float deltaR = 0.4, float min_pt = 40.0, float max_eta = 2.4, float mu_minpt = 20.0, float ele_minpt = 20.0, float rescale = 1.0, int systFlag = 0, bool sort_by_pt = true);

    std::vector<int> getJetMcPhysMatch(int idx, FactorizedJetCorrector* jet_corrector, enum JetType type, float deltaR = 0.4, float min_pt = 40.0, float max_eta = 2.4, float mu_minpt = 20.0, float ele_minpt = 20.0, float rescale = 1.0, int systFlag = 0, bool sort_by_pt = true);

    std::vector<int> getJetMcPhysMatch(int idx, JetCorrectionUncertainty *jet_unc, enum JetScaleType scale_type, enum JetType type, float deltaR = 0.4, float min_pt = 40.0, float max_eta = 2.4, float mu_minpt = 20.0, float ele_minpt = 20.0, bool sort_by_pt = true);	 

    std::vector<int> getJetMcPhysMatch(int idx, FactorizedJetCorrector* jet_corrector, JetCorrectionUncertainty *jet_unc, enum JetScaleType scale_type, enum JetType type, float deltaR = 0.4, float min_pt = 40.0, float max_eta = 2.4, float mu_minpt = 20.0, float ele_minpt = 20.0, bool sort_by_pt = true);	 

    ///////////////////////////////////////////////////////////////////////////////////////////
    // 2012 get the pt sorted btagged jet flags 
    ///////////////////////////////////////////////////////////////////////////////////////////

    std::vector<bool> getSortedBtaggedFlags(int idx, enum JetType type, enum BtagType btag_type, float deltaR = 0.4, float min_pt = 40.0, float max_eta = 2.4, float mu_minpt = 20.0, float ele_minpt = 20.0, float rescale = 1.0, int systFlag = 0);

    std::vector<bool> getSortedBtaggedFlags(int idx, FactorizedJetCorrector* jet_corrector, enum JetType type, enum BtagType btag_type, float deltaR = 0.4, float min_pt = 40.0, float max_eta = 2.4, float mu_minpt = 20.0, float ele_minpt = 20.0, float rescale = 1.0, int systFlag = 0);

    std::vector<bool> getSortedBtaggedFlags(int idx, JetCorrectionUncertainty *jet_unc, enum JetScaleType scale_type, enum JetType type, enum BtagType btag_type, float deltaR = 0.4, float min_pt = 40.0, float max_eta = 2.4, float mu_minpt = 20.0, float ele_minpt = 20.0);	 

    std::vector<bool> getSortedBtaggedFlags(int idx, FactorizedJetCorrector* jet_corrector, JetCorrectionUncertainty *jet_unc, enum JetScaleType scale_type, enum JetType type, enum BtagType btag_type, float deltaR = 0.4, float min_pt = 40.0, float max_eta = 2.4, float mu_minpt = 20.0, float ele_minpt = 20.0);	 
